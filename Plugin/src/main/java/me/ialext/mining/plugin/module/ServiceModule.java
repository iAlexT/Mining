...
import me.ialext.mining.plugin.service.initializer.CommandInitializer;
...
public class ServiceModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    bind(Service.class).named("command-initializer").to(CommandInitializer.class).singleton();
